 ...
 * golden hints, personalized advice, share buttons, FAQ + JSON-LD.
 */
...
<div class="fc-wrap" id="fc-wrap">
    <style>
        ...
        .fc-faq h2 { font-size: 24px; color: #2E1065; margin-bottom: 12px; }
        .fc-faq-item { background: #fff; border-radius: 14px; margin-bottom: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.05); border: 1px solid #EEE8FB; overflow: hidden; }
        .fc-faq-q { width: 100%; min-height: 56px; padding: 16px 18px; background: #fff; border: none; text-align: left; font-size: 15.5px; font-weight: 700; font-family: 'Poppins', sans-serif; color: #1F1933; cursor: pointer; display: flex; justify-content: space-between; align-items: center; gap: 10px; }
        .fc-faq-q::after { content: "+"; font-size: 24px; font-weight: 400; color: #7C3AED; transition: transform .25s; }
        .fc-faq-item.fc-open .fc-faq-q::after { transform: rotate(45deg); }
        .fc-faq-a { padding: 0 18px; max-height: 0; overflow: hidden; transition: max-height .35s ease, padding .35s ease; color: #5B5070; font-size: 14.5px; }
        .fc-faq-item.fc-open .fc-faq-a { padding: 0 18px 18px; max-height: 600px; }
    ...
    <header class="fc-header">
        ...
        <p class="fc-header-sub">Discover the strength of your bond by name &mdash; with best emoji, career match, pet, song &amp; golden hints.</p>
        <div class="fc-stats">
            <div class="fc-stat">
                <div class="fc-stat-num" id="fc-counter">2,76,481</div>
                <div class="fc-stat-lbl">Tests Today</div>
            </div>
            <div class="fc-stat">
                <div class="fc-stat-num">4.9&#9733;</div>
                <div class="fc-stat-lbl">Rating</div>
            </div>
            <div class="fc-stat">
                <div class="fc-stat-num">100%</div>
                <div class="fc-stat-lbl">Free</div>
            </div>
        </div>
    </header>
        ...
        <div class="fc-result" id="fc-result">
            ...
            <div class="fc-bars">
                <div class="fc-bar-row">
                    <div class="fc-bar-top"><span>&#128081; Loyalty</span><span id="fc-b1-v">0%</span></div>
                    <div class="fc-bar"><div class="fc-bar-fill" id="fc-b1"></div></div>
                </div>
                <div class="fc-bar-row">
                    <div class="fc-bar-top"><span>&#127881; Fun &amp; Laughter</span><span id="fc-b2-v">0%</span></div>
                    <div class="fc-bar"><div class="fc-bar-fill" id="fc-b2"></div></div>
                </div>
                <div class="fc-bar-row">
                    <div class="fc-bar-top"><span>&#129303; Trust</span><span id="fc-b3-v">0%</span></div>
                    <div class="fc-bar"><div class="fc-bar-fill" id="fc-b3"></div></div>
                </div>
                <div class="fc-bar-row">
                    <div class="fc-bar-top"><span>&#129704; Emotional Support</span><span id="fc-b4-v">0%</span></div>
            ...
            <!-- Predictions -->
            <div class="fc-preds">
                <div class="fc-pred"><div class="fc-pred-ic" id="fc-pe">&#128153;</div><h4>Best Emoji</h4><div class="fc-pred-val" id="fc-pev">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#128188;</div><h4>Career Match</h4><div class="fc-pred-val" id="fc-pcv">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#128062;</div><h4>Best Pet</h4><div class="fc-pred-val" id="fc-ppv">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#127925;</div><h4>Friendship Song</h4><div class="fc-pred-val" id="fc-psv">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#127912;</div><h4>Bond Color</h4><div class="fc-pred-val" id="fc-pcolv">--</div><span class="fc-pred-swatch" id="fc-pcolsw"></span></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#128197;</div><h4>Lucky Day</h4><div class="fc-pred-val" id="fc-pdv">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#127815;</div><h4>Lucky Number</h4><div class="fc-pred-val" id="fc-pnv">--</div></div>
                <div class="fc-pred"><div class="fc-pred-ic">&#127757;</div><h4>Power Mantra</h4><div class="fc-pred-val" id="fc-pmv">--</div></div>
            </div>
            ...
            <div class="fc-advice">
                <h3>&#129302; Personalized Friendship Advice</h3>
            ...
            <div class="fc-share">
                ...
                <a href="#" class="fc-share-btn fc-sb-tw" id="fc-sb-tw" target="_blank" rel="noopener">&#119991; Twitter</a>
                <button type="button" class="fc-share-btn fc-sb-save" id="fc-sb-save">&#128247; Save Card</button>
                <button type="button" class="fc-share-btn fc-sb-copy" id="fc-sb-copy">&#128279; Copy Link</button>
            </div>

            <button type="button" class="fc-btn fc-try" id="fc-try-btn">&#128260; Try Another Name</button>
        </div>
    </section>

    <section class="fc-levels">
        <div class="fc-lvl"><div class="fc-lvl-icon">&#128081;</div><h4>Soul Friends</h4><div class="fc-lvl-range">90-100%</div><p class="fc-lvl-desc">Once-in-a-lifetime bond</p></div>
        <div class="fc-lvl"><div class="fc-lvl-icon">&#129505;</div><h4>BFFs Forever</h4><div class="fc-lvl-range">70-89%</div><p class="fc-lvl-desc">Inseparable squad</p></div>
        <div class="fc-lvl"><div class="fc-lvl-icon">&#127881;</div><h4>Squad Goals</h4><div class="fc-lvl-range">50-69%</div><p class="fc-lvl-desc">Great vibes, fun crew</p></div>
        <div class="fc-lvl"><div class="fc-lvl-icon">&#129309;</div><h4>Good Pals</h4><div class="fc-lvl-range">30-49%</div><p class="fc-lvl-desc">Friendship in progress</p></div>
        <div class="fc-lvl"><div class="fc-lvl-icon">&#128075;</div><h4>Casual</h4><div class="fc-lvl-range">0-29%</div><p class="fc-lvl-desc">Acquaintance vibes</p></div>
    </section>

    <section class="fc-faq">
        <h2>Friendship Calculator &mdash; FAQs</h2>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">How does the friendship calculator work by name?</button><div class="fc-faq-a"><p>The tool blends three signals from both names: (1) shared-letter overlap, (2) name numerology (digital root), and (3) length harmony. A seeded modifier ensures the same pair always returns the same percentage, while a final blend produces your friendship score, level, and personalized predictions.</p></div></div>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">Is the friendship percentage accurate?</button><div class="fc-faq-a"><p>It&rsquo;s designed for fun, reflection, and conversation starters. The math is deterministic and consistent &mdash; same inputs always give the same output &mdash; but real friendships are built on shared experiences, trust, and time, not just letters.</p></div></div>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">What does &ldquo;Best Pet&rdquo;, &ldquo;Career Match&rdquo;, and &ldquo;Friendship Song&rdquo; mean?</button><div class="fc-faq-a"><p>These are personalized predictions matched to your friendship&rsquo;s vibe profile. The combined name energy is mapped to a curated set of pets, joint career paths, and friendship anthems so each pair gets a unique recommendation.</p></div></div>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">Is my data stored or shared?</button><div class="fc-faq-a"><p>No. Everything is calculated in your browser. Names are never sent to a server, logged, or saved. It&rsquo;s 100% private and works offline once the page is loaded.</p></div></div>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">Can I use Hindi, Urdu, or any regional name?</button><div class="fc-faq-a"><p>Yes &mdash; type the name in Latin (English) letters as you usually spell it. The calculator analyses letters, sums, and lengths, which works perfectly for transliterated names.</p></div></div>
        <div class="fc-faq-item"><button class="fc-faq-q" type="button">Why do same names give the same result?</button><div class="fc-faq-a"><p>The algorithm is fully deterministic &mdash; it uses a seeded function instead of true randomness so your result is reproducible and shareable. Refresh and you&rsquo;ll get exactly the same score.</p></div></div>
    </section>

    <section class="fc-related">
        <h2>Try More Cosmic Calculators</h2>
        <div class="fc-related-grid">
            <a class="fc-rt" href="#mulank"><div class="fc-rt-icon">&#128302;</div><h4>Mulank Calculator</h4><p>Find your numerology root number &amp; ruling planet</p></a>
            <a class="fc-rt" href="#crush"><div class="fc-rt-icon">&#128150;</div><h4>Crush Calculator</h4><p>Does your crush like you back? Find out now</p></a>
            <a class="fc-rt" href="#love"><div class="fc-rt-icon">&#10084;</div><h4>Love Calculator</h4><p>Test true love compatibility by name</p></a>
        </div>
    </section>
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        },
        {
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "How does the friendship calculator work by name?", "acceptedAnswer": { "@type": "Answer", "text": "The tool blends letter overlap, name numerology, and length harmony into a single deterministic friendship score with personalized predictions for emoji, career match, pet, song, color, and lucky day." } },
            { "@type": "Question", "name": "Is the friendship percentage accurate?", "acceptedAnswer": { "@type": "Answer", "text": "It is designed for fun and self-reflection. The math is consistent so the same names always return the same score, but real friendships depend on shared time and trust." } },
            { "@type": "Question", "name": "Is my data private?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. All calculations run inside your browser. No names are sent to any server, logged, or saved." } },
            { "@type": "Question", "name": "Can I use Indian or regional names?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Type the name in Latin letters and the algorithm handles letter frequency, sums, and length comparisons just fine." } }
          ]
        }
      ]
    }
...
(function(){
    ...
    function getLevel(score) {
        if (score >= 90) return { emoji: '👑', name: 'Soul Friends',   color: '#F59E0B' };
        if (score >= 70) return { emoji: '🦅', name: 'BFFs Forever',   color: '#BE185D' };
        if (score >= 50) return { emoji: '🎉', name: 'Squad Goals',    color: '#7C3AED' };
        if (score >= 30) return { emoji: '🤝', name: 'Good Pals',      color: '#2563EB' };
        return { emoji: '👋', name: 'Casual Friends', color: '#14B8A6' };
    }
    ...
    var CAREERS = [
        'Co-founders of a creative startup',
        'Travel vloggers and content duo',
        'Stand-up comedy partners',
        'Music producers and songwriters',
        'Restaurant owners and chefs',
        'Fashion designers and stylists',
        'Tech engineers and product builders',
        'Doctors running a wellness clinic',
        'Teachers running a learning academy',
        'Photographers and filmmakers',
        'Authors writing a bestselling series',
        'Sports coaches and athletes',
        'Wedding planners and event stylists',
        'YouTubers running a hit channel',
        'Architects building dream homes',
        'Game developers shipping indie hits'
    ];
    ...
    var MANTRAS = [
        '"Real friends grow apart and back together — always."',
        '"Loyalty over likes, always."',
        '"One real friend is louder than a hundred fake ones."',
        '"Distance is just a test of true friendship."',
        '"The best therapy is a long talk with a real friend."',
        '"Friendship is when silence feels like home."',
        '"A friend who laughs with you also fights for you."',
        '"Shared memories are the richest currency."'
    ];
    ...
    function buildPredictions(n1, n2, score) {
        ...
        var emoji = pickFromList(seed, EMOJI_POOL);
        var career = pickFromList(seed >> 1, CAREERS);
        var pet = pickFromList(seed >> 2, PETS);
        var song = pickFromList(seed >> 3, SONGS);
        var color = pickFromList(seed >> 4, COLORS_LIST);
        var day = pickFromList(seed >> 5, DAYS);
        var lucky = ((seed >> 6) % 9) + 1;
        var mantra = pickFromList(seed >> 7, MANTRAS);
        return { emoji: emoji, career: career, pet: pet, song: song, color: color, day: day, lucky: lucky, mantra: mantra };
    }

    var loadSteps = [
        '📝 Reading your names...',
        '🔬 Checking shared letters...',
        '✨ Calculating bond energy...',
        '🔮 Drawing your friendship chart...'
    ];
    ...
    function showResult() {
        ...
        FC.score = score; FC.level = level.name;
        ...
        // Hints
        FC.$('fc-hints-title').innerHTML = '⭐ Golden Hints for ' + escapeHtml(n1) + ' &amp; ' + escapeHtml(n2);
        ...
        // Animate predictions
        var predEls = document.querySelectorAll('.fc-pred');
        for (var pi=0; pi<predEls.length; pi++) {
            predEls[pi].style.animationDelay = (pi * 0.07) + 's';
        }
    ...
    elCalcBtn.addEventListener('click', function(){
        ...
        if (!n1 || !n2) { elError.classList.add('fc-show'); return; }
    ...
    var faqs = document.querySelectorAll('#fc-wrap .fc-faq-item');
    faqs.forEach(function(item){
        var q = item.querySelector('.fc-faq-q');
        q.addEventListener('click', function(){ item.classList.toggle('fc-open'); });
    });
